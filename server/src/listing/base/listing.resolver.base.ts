...
export class ListingResolverBase {
  ...
  async createListing(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        whishlist: args.data.whishlist
          ? {
              connect: args.data.whishlist,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => Whishlist, {
    nullable: true,
    name: "whishlist",
  })
  @nestAccessControl.UseRoles({
  ...
  async resolveFieldWhishlist(
    @graphql.Parent() parent: Listing
  ): Promise<Whishlist | null> {
    const result = await this.service.getWhishlist(parent.id);
